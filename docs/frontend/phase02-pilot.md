...
[صفحۀ دمو](https://demos.codestar.ir/semantic-tags/)
را نیز مشاهده کنید تا به صورت دیداری و کاربردی با مفاهیم آشنا شوید.

|   تگ    |                                                                                                                                                                                              توضیحات |                            لینک                            |
| :-----: | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------: | :--------------------------------------------------------: |
| header  |                                                                      معمولاً در بالاترین بخش صفحه یا المان مورد نظر قرار می‌گیرد و در اکثر مواقع شامل لوگو، `nav` و دکمه‌های Call-to-Action می‌باشد. | [مشاهده](https://demos.codestar.ir/semantic-tags/#header)  |
|   nav   |                                                                                                                                          شامل لینک‌هایی به قسمت‌های مختلف صفحۀ اصلی یا سایت می‌باشد. |   [مشاهده](https://demos.codestar.ir/semantic-tags/#nav)   |
|  main   |                                                                                                                   شامل محتوای اصلی سایت می‌باشد و در اکثر مواقع بیشترین حجم از صفحه را اشغال می‌کند. |  [مشاهده](https://demos.codestar.ir/semantic-tags/#main)   |
|  aside  |                                                         شامل محتوایی غیر از محتوای اصلی می‌باشد به طوری که نمی‌توان آن را در `main` قرار داد. به‌عنوان مثال تبلیغات یا لینک به قسمت‌های مختلف مقاله. |  [مشاهده](https://demos.codestar.ir/semantic-tags/#aside)  |
| footer  |                                              معمولاً در پایین‌ترین بخش صفحه یا المان مورد نظر قرار می‌گیرد و در اکثر مواقع شامل Copyright، توضیحات مختصری در مورد سایت و شخص یا گروه سازنده می‌باشد. | [مشاهده](https://demos.codestar.ir/semantic-tags/#footer)  |
| article | بخشی از محتواست که کاملاً از بخش‌های دیگر مستقل می‌باشد به گونه‌ای که می‌توان آن را به طور جداگانه استفاده یا منتشر کرد. به‌عنوان مثال می‌توان به مقاله‌ای از یک مجله یا پستی از یک وبلاگ اشاره کرد. | [مشاهده](https://demos.codestar.ir/semantic-tags/#article) |
| section |       بخشی از محتوای اصلی سایت را مشخص می‌کند. معمولاً از این تگ برای ایجاد تمایز بینِ قسمت‌های مختلف استفاده می‌شود. معمولاً در ابتدای هر بخش از `heading` یعنی تگ‌های `h1` تا `h6` استفاده می‌شود. | [مشاهده](https://demos.codestar.ir/semantic-tags/#results) |
| details |                                                                                                                       شامل بخشی از محتواست که کاربر می‌تواند در صورت نیاز آن را نمایان یا پنهان کند. | [مشاهده](https://demos.codestar.ir/semantic-tags/#details) |
| summary |                                                                                                                       همیشه داخل المان `details` استفاده می‌شود و باید شامل توضیحاتی دربارۀ آن باشد. | [مشاهده](https://demos.codestar.ir/semantic-tags/#summary) |
